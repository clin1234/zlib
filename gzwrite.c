...
/* Local functions */
local int gz_init (gz_state*);
local int gz_comp (gz_state*, int);
local int gz_zero (gz_state*, z_off64_t);
local size_t gz_write (gz_state*, const void*, size_t);
