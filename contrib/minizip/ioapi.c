...
void* call_zopen64 (const zlib_filefunc64_32_def* pfilefunc,const void*filename,int mode)
{
...
long call_zseek64 (const zlib_filefunc64_32_def* pfilefunc,void* filestream, ZPOS64_T offset, int origin)
{
    if (pfilefunc->zfile_func64.zseek64_file != NULL)
        return (*(pfilefunc->zfile_func64.zseek64_file)) (pfilefunc->zfile_func64.opaque,filestream,offset,origin);
    else
    {
        unsigned long offsetTruncated = (unsigned long)offset;
...
ZPOS64_T call_ztell64 (const zlib_filefunc64_32_def* pfilefunc,void* filestream)
{
    if (pfilefunc->zfile_func64.zseek64_file != NULL)
        return (*(pfilefunc->zfile_func64.ztell64_file)) (pfilefunc->zfile_func64.opaque,filestream);
    else
    {
        unsigned long tell_uLong = (*(pfilefunc->ztell32_file))(pfilefunc->zfile_func64.opaque,filestream);
...
static unsigned long   ZCALLBACK fread_file_func OF((void* opaque, void* stream, void* buf, unsigned long size));
static unsigned long   ZCALLBACK fwrite_file_func OF((void* opaque, void* stream, const void* buf,unsigned long size));
static ZPOS64_T ZCALLBACK ftell64_file_func OF((void* opaque, void* stream));
static long    ZCALLBACK fseek64_file_func OF((void* opaque, void* stream, ZPOS64_T offset, int origin));
static int     ZCALLBACK fclose_file_func OF((void* opaque, void* stream));
static int     ZCALLBACK ferror_file_func OF((void* opaque, void* stream));
